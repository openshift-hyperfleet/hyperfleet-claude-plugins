...
4. Flag inconsistent log levels for the same type of event within the diff
...
- **Inconsistent spelling** within the diff — the same concept spelled differently in different places (e.g., `canceled` vs `cancelled`, `color` vs `colour`)
